package com.hbs.site.framework.web.config;
...
import com.hbs.site.framework.web.core.filter.CacheRequestBodyFilter;
import com.hbs.site.framework.web.core.filter.DemoFilter;
import com.hbs.site.framework.web.core.handler.GlobalExceptionHandler;
import com.hbs.site.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class HbsWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "hbs.demo", havingValue = "true")
