package com.hbs.site.framework.swagger.config;
...
import static com.hbs.site.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class HbsSwaggerAutoConfiguration {
