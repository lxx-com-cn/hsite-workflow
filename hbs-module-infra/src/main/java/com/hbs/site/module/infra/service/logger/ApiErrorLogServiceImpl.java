package com.hbs.site.module.infra.service.logger;
...
import com.hbs.site.framework.common.util.string.StrUtils;
...
import com.hbs.site.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.hbs.site.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.hbs.site.module.infra.dal.dataobject.logger.ApiErrorLogDO.REQUEST_PARAMS_MAX_LENGTH;
import static com.hbs.site.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.hbs.site.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
    ...
    public void createApiErrorLog(ApiErrorLogCreateReqDTO createDTO) {
        ...
        try {
           /* if (TenantContextHolder.getTenantId() != null) {
            ...
            // 兜底处理，目前只有 hbs-cloud 会发生：https://gitee.com/hbscode/hbs-cloud-mini/issues/IC1O0A
