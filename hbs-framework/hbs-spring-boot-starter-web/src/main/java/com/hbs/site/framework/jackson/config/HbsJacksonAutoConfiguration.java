package com.hbs.site.framework.jackson.config;

import com.hbs.site.framework.common.util.json.JsonUtils;
import com.hbs.site.framework.common.util.json.databind.NumberSerializer;
import com.hbs.site.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.hbs.site.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class HbsJacksonAutoConfiguration {
