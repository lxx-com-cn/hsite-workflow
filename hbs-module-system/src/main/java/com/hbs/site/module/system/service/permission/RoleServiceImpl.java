...
import com.hbs.site.module.system.dal.mysql.permission.RoleMapper;
...
import com.hbs.site.module.system.enums.permission.RoleCodeEnum;
...
public class RoleServiceImpl implements RoleService {
    ...
    public Long createRole(RoleSaveReqVO createReqVO, Integer type) {
        ...
        RoleDO role = BeanUtils.toBean(createReqVO, RoleDO.class)
                ...
                .setDataScopeDeptIds(new HashSet<>()); // ✅ 关键：设置空集合，避免 NULL
