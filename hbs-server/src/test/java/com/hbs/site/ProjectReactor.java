...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hbs.site";
    private static final String ARTIFACT_ID = "hbs";
    private static final String PACKAGE_NAME = "com.hbs.site";
    private static final String TITLE = "hbs-site";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hbs.site";
        String artifactIdNew = "hbs";
        String packageNameNew = "com.hbs.site";
        String titleNew = "hbs-site";
