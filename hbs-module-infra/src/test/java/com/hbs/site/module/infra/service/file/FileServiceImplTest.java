...
import com.hbs.site.framework.test.core.util.AssertUtils;
...
import com.hbs.site.module.infra.dal.mysql.file.FileMapper;
...
import static com.hbs.site.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFile_success_01() throws Exception {
        ...
        // 校验数据
        FileDO file = fileMapper.selectOne(FileDO.URL, url);
