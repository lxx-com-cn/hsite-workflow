package com.hbs.site.module.system.service.oauth2;
...
import com.hbs.site.framework.common.exception.enums.GlobalErrorCodeConstants;
import com.hbs.site.framework.common.pojo.PageResult;
import com.hbs.site.framework.common.util.date.DateUtils;
import com.hbs.site.framework.common.util.object.BeanUtils;
import com.hbs.site.framework.security.core.LoginUser;
///import com.hbs.site.framework.tenant.core.context.TenantContextHolder;
///import com.hbs.site.framework.tenant.core.util.TenantUtils;
...
import com.hbs.site.module.system.dal.dataobject.oauth2.OAuth2RefreshTokenDO;
import com.hbs.site.module.system.dal.dataobject.user.AdminUserDO;
import com.hbs.site.module.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import com.hbs.site.module.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import com.hbs.site.module.system.dal.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
import static com.hbs.site.framework.common.util.collection.CollectionUtils.convertSet;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    /**
     * 加载用户信息，方便 {@link com.hbs.site.framework.security.core.LoginUser} 获取到昵称、部门等信息
     *
     * @param userId 用户编号
     * @param userType 用户类型
     * @return 用户信息
