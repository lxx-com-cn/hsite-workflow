package com.hbs.site.module.infra.service.file;
...
import com.hbs.site.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.hbs.site.module.infra.convert.file.FileConfigConvert;
import com.hbs.site.module.infra.dal.dataobject.file.FileConfigDO;
import com.hbs.site.module.infra.dal.mysql.file.FileConfigMapper;
import com.hbs.site.module.infra.framework.file.core.client.FileClient;
...
import static com.hbs.site.framework.common.util.cache.CacheUtils.buildAsyncReloadingCache;
import static com.hbs.site.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.hbs.site.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImpl implements FileConfigService {
    ...
    public void updateFileConfigMaster(Long id) {
        ...
        // 更新其它为非 master（批量更新所有记录）
        fileConfigMapper.updateByQuery(
                new FileConfigDO().setMaster(false),
                QueryWrapper.create()  // 空条件表示更新所有记录
        );
        // 更新
