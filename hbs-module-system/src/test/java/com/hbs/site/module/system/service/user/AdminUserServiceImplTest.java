package com.hbs.site.module.system.service.user;
...
import com.hbs.site.framework.common.util.collection.ArrayUtils;
import com.hbs.site.framework.common.util.collection.CollectionUtils;
import com.hbs.site.framework.test.core.ut.BaseDbUnitTest;
import com.hbs.site.module.infra.api.config.ConfigApi;
import com.hbs.site.module.infra.api.file.FileApi;
import com.hbs.site.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.hbs.site.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.hbs.site.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.hbs.site.module.system.controller.admin.user.vo.user.UserImportRespVO;
...
///import com.hbs.site.module.system.dal.dataobject.tenant.TenantDO;
import com.hbs.site.module.system.dal.dataobject.user.AdminUserDO;
import com.hbs.site.module.system.dal.mysql.dept.UserPostMapper;
import com.hbs.site.module.system.dal.mysql.user.AdminUserMapper;
import com.hbs.site.module.system.enums.common.SexEnum;
import com.hbs.site.module.system.service.dept.DeptService;
import com.hbs.site.module.system.service.dept.PostService;
import com.hbs.site.module.system.service.permission.PermissionService;
///import com.hbs.site.module.system.service.tenant.TenantService;
...
import static com.hbs.site.framework.common.util.collection.SetUtils.asSet;
import static com.hbs.site.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.hbs.site.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.hbs.site.framework.common.util.object.ObjectUtils.cloneIgnoreId;
...
import static com.hbs.site.framework.test.core.util.RandomUtils.*;
import static com.hbs.site.module.system.enums.ErrorCodeConstants.*;
import static com.hbs.site.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("hbsyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("hbsyuanma");
        ...
        assertEquals("hbsyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("hbsyuanma"))).thenReturn("java");
